...
const MyProfile = () => {
  ...
  return (
    <div className="max-w-lg flex  flex-col gap-2 text-sm">
      <img src={userData.image} alt="" className="w-36 rounded-full" />
      {isEdit ? (
        <input
      ...
      <div className="mt-10">
        {isEdit ? (
          <button
            className="border-primary border cursor-pointer px-8 py-2 rounded-md hover:bg-primary hover:text-white transition-all"
