...
//this file will be created dynamic , when backend will be created
        ...
        {doctors.slice(0, 3).map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 justify-end">
              ...
              <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded-md  hover:bg-red-400 hover:text-white transition-all duration-300">
                Cancel Appointment
              </button>
            </div>
          </div>
